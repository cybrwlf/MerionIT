...
Write-Host "Disabling UAC..."
            # This below is the mode which can break some apps. Please. Leave this on 1.
...
Write-Host "Showing known file extensions..."
			...
			Stop-Process -processName: Explorer -force # Stop the Explorer service
...
Write-Host "Outlook Navigation to the bottom"
            If (!(Test-Path "HKCU:\SOFTWARE\Microsoft\Office\16.0\Common\ExperimentEcs\Overrides")) {
                New-Item -Path "HKCU:\SOFTWARE\Microsoft\Office\16.0\Common\ExperimentEcs\Overrides" | Out-Null
            }

			Set-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Office\16.0\Common\ExperimentEcs\Overrides" -Name "MicrosoftDoesNotListen" -Type String -Value "true"

			Set-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Office\16.0\Common\ExperimentEcs\Overrides" -Name "Microsoft.Office.Outlook.Hub.HubBar" -Type String -Value "false"

            If (!(Test-Path "HKCU:\SOFTWARE\Microsoft\Office\16.0\Common\ExperimentEcs\Overrides\Outlook")) {
                New-Item -Path "HKCU:\SOFTWARE\Microsoft\Office\16.0\Common\ExperimentEcs\Overrides\Outlook" | Out-Null
            }
			Set-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Office\16.0\Common\ExperimentEcs\Overrides\Outlook" -Name "Microsoft.Office.Outlook.PreviewPlace.Cleanup" -Type String -Value "MicrosoftDoesNotListen"
...
Write-Host "Delay Feature updates"
