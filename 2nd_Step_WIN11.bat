...
echo [Step 13 of 15] Cleaning Windows Update cache...
powershell.exe -ExecutionPolicy UnRestricted -File tweaks\Clean_win_updates_cache.ps1
echo [Step 14 of 15] Vendor drivers (Dell Command Update, or Windows Update elsewhere)...
powershell.exe -ExecutionPolicy UnRestricted -File tweaks\vendor-drivers.ps1
echo [Step 15 of 15] Applying power configuration...
